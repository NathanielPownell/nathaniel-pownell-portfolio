...
import SurveyImg from './survey.gif'
    ...
    return (
        <animated.div id="projects" style={styles} className={classes.contentdiv}>
            ...
            <div className={classes.projects}>
                ...
                <Card image={SurveyImg} title="Coming Soon - Survey Web app!" desc="Create and edit a survey and generate a link to send to friends." techs={['Django/DjangoREST', 'ReactJs']} displayButtons={false} />
